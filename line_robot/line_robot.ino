...
void setup() 
  {    
      ...
      pos_motor_cal(10, 10, 15);         // ตั้งค่า มอเตอร์ สำหรับ การคาริเบลท
      ...
      to_brake_fc(10, 30);            // ตั้งค่าในการหยุดมอเตอร์ก่อนหมุนซ้ายขวา to_brake_fc(...f..., ....c...); 
