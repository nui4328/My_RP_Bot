...
for(int i=0; i<3; i++)
  {
    fline(30, 30, 0.45, 0, 'c', 'r', 50, "a4", 20);     
    arm_down_close();
    
    fline(50, 50, 0.45, 0, 'c', 'l', 50, "a3", 20); 
    fline(30, 30, 0.85, "a0", 'f', 'p', 50, "a3", 0); 
    fline(30, 30, 0.85, "a7", 'f', 'r', 90, "a4", 1); 
    fline(60, 60, 0.65, 20, 'f', 'r', 90, "a4", 1); 
    fline(60, 60, 0.65, 55, 'f', 's', 90, "a3", 1);

    bline(50, 50, 0.85, 20, 'c', 'l', 50, "a3", 20);
    fline(30, 30, 0.85, 72, 'n', 's', 50, "a4", 1);
    fline(30, 30, 0.50, "a7", 'f', 'r', 90, "a4", 1); 
    fline(30, 30, 0.55, "a0", 'f', 'l', 90, "a3", 1); 
    fline(30, 30, 0.85, "a07", 'n', 's', 50, "a4", 1);   
    fline(0, 0, 0.85, 0, 'c', 'r', 50, "a4", 1); 
    fline(0, 0, 0.85, 0, 'c', 'r', 50, "a4", 20); 

    fline(30, 30, 0.55, "a0", 'f', 'l', 90, "a3", 1); 
    fline(30, 30, 0.50, "a7", 'f', 'r', 90, "a4", 1); 
    fline(30, 30, 0.55, "a0", 'f', 'l', 90, "a3", 1); 
    fline(30, 30, 0.85, "a07", 'f', 'r', 90, "a4", 1);

    fline(70, 70, 0.45, 25, 'f', 'l', 90, "a3", 1); 
    fline(70, 70, 0.45, 25, 'f', 'l', 90, "a3", 1);

    fline(30, 30, 0.95, "a7", 'f', 'p', 50, "a3", 0); 
    fline(30, 30, 0.95, "a7", 'f', 'r', 90, "a4", 1); 
    fline(70, 70, 0.85, 20, 'f', 'l', 90, "a3", 1); 
    fline(30, 30, 0.85, 0, 'c', 's', 90, "a3", 20); 
    delay(300);
    
    place_left_in(20, 30, 5) ;
    fw_gyro(20, 20, 1.25, 20,  10) ;
    place_right_in(30, 35, 5) ;
    delay(1000);
    place_right_out(20, 27, 5) ;
    bw_gyro(30, 30, 1.25, 20, 10) ;
    fline(0, 0, 0.85, 0, 'n', 'l', 40, "a3", 1); 
    fline(0, 0, 0.85, 0, 'n', 'l', 40, "a3", 10); 
  }
