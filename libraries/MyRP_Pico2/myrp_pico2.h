...
EncoderLibrary encoder(18, 22, 12, 11);
...
int sensorValuesC[2][numSamples]; // เก็บข้อมูลจาก analogRead(26) และ analogRead(27)
int sensorMaxC[2]; // Max สำหรับพิน 46 และ 27
int sensorMinC[2]; // Min สำหรับพิน 46 และ 27
...
void setup_robot() 
  {
   ...
   // resetAngles();
    ...
    for(int i = 0; i<2; i++)
      ...
      if (!my.begin()) {
        Serial.println("BMI160 ไม่เจอ!");
        while (1);
      }
      Serial.println("BMI160 พร้อมใช้งาน!");
      resetAngles();
  ...
  while (1) 
      {
        ...
        if(sensorss == "a0")
          ...
          {
             if(analogRead(26)  < (sensorMin_C[0]+sensorMax_C[0])/2)
              {
                break;
              }
          }
          ...
          {
             if(analogRead(27)  < (sensorMin_C[1]+sensorMax_C[1])/2)
              {
                break;
              }
          }
  ...
  if(sp == 'p')
    {
      if(sensorss == "a0")
          ...
          {
            do{Motor(spl, spr);delayMicroseconds(50);}while(analogRead(26)  < (sensorMin_C[0]+sensorMax_C[0])/2);
          }
        else if(sensorss == "c1")
          {
             do{Motor(spl, spr);delayMicroseconds(50);}while(analogRead(27)  < (sensorMin_C[0]+sensorMax_C[1])/2);
          }
      }
    else{}
    // soft stop
