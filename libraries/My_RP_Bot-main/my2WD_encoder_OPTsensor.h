...
void waiting_start()
  {
    ...
    while(1)
      {   
         if(analogRead(29) < 500 )   
            {
               mydisplay_background(black);
               mydisplay("MY-MAKERS", 25, 15, 2, white);
               mydisplay("start-root", 10, 40, 2, white);
               if(digitalRead(9)==0) 
                  {
                     goto end_begin;
                  }
               ...
               while(1)
                  {
                     mydisplay_background(black);
                     mydisplay("> ", 2, 5, 2, red);
                     mydisplay(" Read Sensor", 10, 5, 2, white);
                     mydisplay(" Cal Sensor", 10, 30, 2, white);
                     mydisplay(" Cal Collor", 10, 60, 2, white);
                     if(digitalRead(9)==0) 
                        {
                           bz(100);
                           while(1)
                              {
                                 mydisplay_background(black);
                                 mydisplay("> ", 2, 4, 2, red);
                                 mydisplay(" Encoder", 10, 4, 2, white);
                                 mydisplay(" S ON-bord ", 10, 24, 2, white);
                                 mydisplay(" SPI 0", 10, 45, 2, white);
                                 mydisplay(" SPI 20", 10, 65, 2, white);
                                 //goto end_begin;
                              }
                        }
                     if(analogRead(29) < 500 || analogRead(29) > 1500)
               ...
               while(1)
                  {
                     ...
                     if(analogRead(29) < 1500 || analogRead(29) > 2500)
                        {
               ...
               while(1)
                  {
                     ...
                     if(analogRead(29) < 2500 || analogRead(29) > 3500)
                        {
