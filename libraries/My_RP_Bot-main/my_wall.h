...
{  
    ...
    while (true) {
       ...
       // Serial.println(yaw); // Debug ดูค่า yaw
        ...
        if(digitalRead(27) == 0 && digitalRead(28) == 1 ) 
          {
            Motor(-1, -(rightSpeed/2));
             my_GYRO::resetAngles();
          } 
        else if (digitalRead(27) == 1 && digitalRead(28) == 0 ) 
          {
            Motor(-(leftSpeed/2), -1);
             my_GYRO::resetAngles();
          }
        else if (digitalRead(27) == 0 && digitalRead(28) == 0 ) 
          {
        ...
        while(1)
          {
            if(digitalRead(27) == 0 && digitalRead(28) == 1 ) 
              {
                 do{Motor(-5, 30);}  while(digitalRead(28) == 1);
                 Motor(2, -20); delay(10);
                 break;       
              }
            else if(digitalRead(27) == 1 && digitalRead(28) == 0 ) 
              {
                do{Motor(30, -5);}  while(digitalRead(27) == 1); 
                Motor(-20, -2); delay(10);                     
                break;       
              }
            else if(digitalRead(27) == 0 && digitalRead(28) == 0 ) 
        ...
        while(1)
          {
            if(digitalRead(0) == 0 && digitalRead(1) == 1 ) 
              {
                ch_lrs = 'l';
                do{Motor(5, -30);}  while(digitalRead(1) == 1);
                 Motor(-2, 20); delay(10);
                 break;      
              }
              ...
              {
                ch_lrs = 'r';
                do{Motor(-30, 5);}  while(digitalRead(0) == 1);
                 Motor(20, -2); delay(10);
                 break;        
              }
           else if(digitalRead(0) == 0 && digitalRead(1) == 0 ) 
              {   
                if(ch_lrs == 'l')
                  {
                     Motor(15, 5);delay(20);
