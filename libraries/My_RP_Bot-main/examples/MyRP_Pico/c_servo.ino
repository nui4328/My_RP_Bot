...
int servo_down = 58;      //-------------------->> ตั้งค่า มื่อจับลงขนานกับพื้น
...
void arm_ready()
  {
    servo(8, servo_down);
    servo(0, servoL_open - 50);
    servo(1, servoR_open + 50);
  }
...
void arm_down_close()
  {
    servo(8, servo_down);
    servo(0, servoL_open-117);
    servo(1, servoR_open+114);
  }
void arm_big_box()
  {
    servo(8, servo_down);
    servo(0, servoL_open - 70);
    servo(1, servoR_open + 70);
  }
