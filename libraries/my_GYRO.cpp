...
// เริ่มต้นเซ็นเซอร์
bool my_GYRO::begin() {
      Wire1.begin(); // เริ่ม I2C1
      Wire1.setClock(400000); // ตั้งความถี่ I2C เป็น 400kHz

      // ตรวจสอบ chip ID
      Wire1.beginTransmission(_address);
      Wire1.write(my_GYRO_CHIP_ID);
...
/* 
      Wire.begin(); // เริ่ม I2C1
      Wire.setClock(400000); // ตั้งความถี่ I2C เป็น 400kHz
