      ...
      if (tim >= 1)
         {
            ...
            //Motor(-30, -30); delay(20); Motor(0, 0); sw();
        ...
        for(int i=10; i<sl; i++)
          {
            ...
            Motor(i + PID_output, i - PID_output);
             if(mcp_f(2) < min_mcp_f(2) || mcp_f(1) < min_mcp_f(1))
                          {
                            do{Motor(sl/2, sl);} while(mcp_f(3) > min_mcp_f(3) );
                          }
                        if(mcp_f(5) < min_mcp_f(5) || mcp_f(6) < min_mcp_f(6))
                          {
                            do{Motor(sl, sl/2);} while(mcp_f(4) > min_mcp_f(4) );
                          }
            delay(3);
          }
        while(encoder.Poss_R() > -new_encoder)
