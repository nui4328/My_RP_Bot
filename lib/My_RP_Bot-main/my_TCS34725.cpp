 ...
 *  @param  value
 */
void my_TCS34725::write8(uint8_t reg, uint8_t value) {
 ...
 *  @return value
 */
uint8_t my_TCS34725::read8(uint8_t reg) {
 ...
 *  @return value
 */
uint16_t my_TCS34725::read16(uint8_t reg) {
 ...
 *          Gain
 */
my_TCS34725::my_TCS34725(uint8_t it, tcs34725Gain_t gain) {
 ...
 */
boolean my_TCS34725::begin(uint8_t addr, TwoWire *theWire) {
  if (i2c_dev)
    delete i2c_dev;
  i2c_dev = new my_I2CDevice(addr, theWire);
 ...
 *          Integration Time
 */
void my_TCS34725::setIntegrationTime(uint8_t it) {
 ...
 *          Clear channel value
 */
void my_TCS34725::getRawData(uint16_t *r, uint16_t *g, uint16_t *b,
                                   uint16_t *c) {
  if (!_tcs34725Initialised)
    begin();
 ...
 *          Clear channel value
 */
void my_TCS34725::getRawDataOneShot(uint16_t *r, uint16_t *g, uint16_t *b,
                                          uint16_t *c) {
  if (!_tcs34725Initialised)
    begin();
 ...
 */
void my_TCS34725::getRGB(float *r, float *g, float *b) {
 ...
 */
uint16_t my_TCS34725::calculateColorTemperature(uint16_t r, uint16_t g,
                                                      uint16_t b) {
 ...
 *  @return Color temperature in degrees Kelvin
 */
uint16_t my_TCS34725::calculateColorTemperature_dn40(uint16_t r,
                                                           uint16_t g,
                                                           uint16_t b,
                                                           uint16_t c) {
 ...
 */
void my_TCS34725::setInterrupt(boolean i) {
 ...
 */
void my_TCS34725::clearInterrupt() {
