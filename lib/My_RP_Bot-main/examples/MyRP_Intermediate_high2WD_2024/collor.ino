...
void mision_color()
  {
    ...
    do{Motor(-20, -20);}while(mcp_f(0) < md_mcp_f(0)&& mcp_f(7) < md_mcp_f(7));
    while(1)
              {
    ...
    if(LR_free == true)
      {
        if(num_encoder < 800)
          {
            do{Motor(-30, -30);}while(encoderPos > -1550);
          }
        else
          {
            do{Motor(-30, -30);}while(encoderPos > -(num_encoder+1100));
          }        
      }
    else
      {
        if(num_encoder < 800)
          ...
          {
            do{Motor(-30, -30);}while(encoderPos > -(num_encoder+100));
          }
        
      }
    */

    do{Motor(-30, -30);}while(encoderPos > -1200);
    num_encoder = 0;
    Motor(30, 30); delay(20);
    Motor(-1, -1); delay(30);
    Motor(0, 0);   delay(100);  
    encoderPos = 0;
    do{Motor(-30, 30);}while(encoderPos > -(rotate_color));   //------------------>> หมุ่นซ้าย 
    ...
    if(LR_free == true)
      {
        if(num_encoder < 800)
          {
            do{Motor(-30, -30);}while(encoderPos > -1450);
          }
        else
          {
            do{Motor(-30, -30);}while(encoderPos > -(num_encoder+300));
          }        
      }
    else
      {
