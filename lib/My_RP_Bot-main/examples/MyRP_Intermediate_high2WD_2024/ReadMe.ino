void read_me()
    {
      ...
      rotate_rights(90, 1000);       // หมุนขวา ด้วยความเร็ว 90% ด้วยการหมุนของล้อที่ 1000 รอบ
      rotate_lefts(90, 1000);
     ...
     //------------------------------------------------------>>>>>
      ...
      move_fw(40, 40, 1660);  // ระดับสูง
      get_color();

      
      fw(40, 40, 3000, "line"); delay(500);
      bw(40, 40, 5000, "line"); 
      set_f(2);
      fw(40, 40, 5000, "line");
