void read_me()
  {
    sw();                           //--------->>> คำสั่งรอปุ่มกด
      ...
      fline_setpoint(40,40,0.4, 50,"a7", 30);   //  ----->> 50 คือ ตำแหน่งที่ต้องการเซต 0-100 / 50 อยู่ตรงกลาง
      ...
      fline_2sensor(35, 35, 0.5, 0, "3:4","a7", 's', 30);  // คำสั่งเลือกเดินตามเส้น แค่ 2 เซนเซอร์ เลือกเซนเซอร์ในการเช็คเส้น เหมือน fline_setpoint
