...
int min_can_color = 300;      //  กระป๋องดำ
int max_can_color = 1300;   //  กระป๋องขาว
void setup() 
  {    
      Serial.begin(9600);
      ...
      to_brake_fc(10, 20);            // ตั้งค่าในการหยุดมอเตอร์ก่อนหมุนซ้ายขวา to_brake_fc(...f..., ....c...); 
...
void loop() 
  {  
      ...
      Serial.print(analogRead(28));  // วัดระยะ
      Serial.print("   ");
      Serial.println(analogRead(29));  // สีกระปอง
      delay(10);
