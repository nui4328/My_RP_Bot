    ...
    if(slr == 'r')
      {
        if(error_Yaw()> 20)
          ...
          {
            do{Motor(70,-70);}while(error_Yaw()< f_deg_r);
    ...
    else if(slr == 'l')
      {
        if(error_Yaw()< -20)
          ...
          {
            do{Motor(-70,70);}while(error_Yaw()> f_deg_l);
            Motor(60,-60);delay(50);
            Motor(0,0);delay(100);
          }
    ...
    if(slr == 'r')
      { 
        if(error_Yaw()> 20)
          ...
          {
            do{Motor(70,-70);}while(error_Yaw()< b_deg_r);
            Motor(-60,60);delay(50);
            Motor(0,0);delay(100);
          }
    ...
    else if(slr == 'l')
      {
        if(error_Yaw()< -20)
          ...
          {
            do{Motor(-70,70);}while(error_Yaw()> b_deg_l);
            Motor(60,-60);delay(50);
            Motor(0,0);delay(100);
          }
